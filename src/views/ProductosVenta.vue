  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-100 via-gray-100 to-indigo-100 py-10 px-6">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="flex justify-between items-center mb-8">
        ...
        <div>
          <div class="sticky top-20 z-40 bg-slate-100 py-4 mb-8">

            <div class="bg-white rounded-2xl shadow-xl border border-gray-200">

              <div class="flex justify-between items-center px-6 py-4">

                <h1 class="text-2xl md:text-4xl font-black text-slate-800">
                  Productos en Venta
                </h1>

                <RouterLink to="/carrito"
                  class="relative bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-3 rounded-xl shadow-lg transition">
                  🛒 Carrito
