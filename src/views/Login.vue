    ...
    <div class="max-w-md w-full space-y-8 p-10 bg-white rounded-xl shadow-lg z-10">
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-gray-600">
          O <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500">regístrate para una nueva cuenta</a>
        </p>
      </div>
...
const handleLogin = () => {
  ...
  // Por ahora, solo mostramos una alerta con los datos ingresados
};
</script>
